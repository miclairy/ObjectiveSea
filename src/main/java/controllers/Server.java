...
import src.main.java.models.Collision;
import src.main.java.models.Race;
import src.main.java.data.AC35StreamXMLMessage;
...
public class Server implements Runnable, Observer {
    ...
    private void initialize() throws IOException  {
        ...
        xmlSequenceNumber.put(AC35StreamXMLMessage.REGATTA_XML_MESSAGE, 0);
        xmlSequenceNumber.put(AC35StreamXMLMessage.RACE_XML_MESSAGE, 0);
        xmlSequenceNumber.put(AC35StreamXMLMessage.BOAT_XML_MESSAGE, 0);
    ...
    private void sendInitialRaceMessages() {
        sendXmlMessage(AC35StreamXMLMessage.RACE_XML_MESSAGE, "Race.xml");
        sendXmlMessage(AC35StreamXMLMessage.BOAT_XML_MESSAGE, "Boat.xml");
        sendXmlMessage(AC35StreamXMLMessage.REGATTA_XML_MESSAGE, "Regatta.xml");
    }
