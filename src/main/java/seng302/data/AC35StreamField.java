...
public enum AC35StreamField {
    ...
    HOST_GAME_IP(0, 3), HOST_GAME_PORT(3, 7), HOST_GAME_MAP(7, 8), HOST_GAME_SPEED(8, 9), HOST_GAME_STATUS(9, 10), HOST_GAME_REQUIRED_PLAYERS(10, 11),
    HOST_GAME_CURRENT_PLAYERS(11, 12);
