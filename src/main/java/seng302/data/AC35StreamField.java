...
public enum AC35StreamField {
    ...
    //boat Location
    BOAT_TIMESTAMP(1, 7), BOAT_SOURCE_ID(7, 11), BOAT_SEQUENCE_NUM(11, 15),LATITUDE(16, 20), LONGITUDE(20, 24), HEADING(28, 30),
    SPEED_OVER_GROUND(38, 40), DEVICE_TYPE(15, 16), TRUE_WIND_DIRECTION(46, 48), TRUE_WIND_ANGLE(48, 50),
