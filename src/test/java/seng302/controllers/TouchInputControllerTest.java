...
public class TouchInputControllerTest {
    ...
    public void checkRotationTest() {
        ...
        boolean upwind3 = TouchInputController.checkRotation(45.0, 320.0, 300.0);
        boolean downwind3 = TouchInputController.checkRotation(320.0, 45.0, 300.0);
        assert(upwind3);
        assert(!downwind3);

        boolean upwind4 = TouchInputController.checkRotation(180.0, 270.0, 300.0);
